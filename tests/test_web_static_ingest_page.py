...
class WebStaticIngestPageTestCase(unittest.TestCase):
    ...
    def test_ingest_page_exists_and_has_upload_controls(self):
        ...
        self.assertIn('id="fileTriggerButton"', html)
        self.assertIn('id="fileMeta"', html)
        self.assertIn("拖拽 PDF 到这里", html)
    ...
    def test_ingest_page_polls_job_status(self):
        ...
        self.assertIn("function updateSelectedFile", html)
        self.assertIn('fileDropzone.addEventListener("dragover"', html)

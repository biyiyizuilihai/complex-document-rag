...
# 添加项目根目录到 Python 路径，以便导入 config 和 data_models
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from config import OPENAI_API_KEY, OPENAI_BASE_URL, MULTIMODAL_LLM_MODEL
...
# ============================================================
# LlamaIndex 的 OpenAIMultiModal 和 OpenAI 类会校验模型名称，
# 只允许 OpenAI 官方模型（gpt-4o 等），Qwen 等第三方模型会被拒绝。
#
# DashScope（通义千问）提供了完全兼容 OpenAI 的 API 接口，
